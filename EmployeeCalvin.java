...
public class EmployeeCalvin {
	...
	ArrayList<EmployeeCalvin> EmployeeCalvinList = new ArrayList<>();
	...
	EmployeeCalvin(String name,String position, int id, double wage, double hour){
		this.name = name;
	...
	void addEmp(EmployeeCalvin newEmp) {
		EmployeeCalvinList.add(newEmp);
	}
	
	void removeEmp(EmployeeCalvin emp) {
		EmployeeCalvinList.remove(emp);
	}
	
	ArrayList<EmployeeCalvin> empList()
	{
